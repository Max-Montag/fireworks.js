    ...
    new p5((p) => {
        ...
        class FireworksEnv {
            constructor(wrapperID, imgLoc, settings) {
                ...
                this.launchRandomRockets = settings.launchRandomRockets || true; // wheter to launch random rockets while showing messages
                ...
                for (let i = 0; i < word.length; i++) {
                    setTimeout(() => {
                        ...
                        let acc = p.createVector(
                            ...
                            -10 - ((this.canvas.height - 100 + p.random(200)) / 100) // somewhat responsive
                        );
                    ...
                    for (let velVec of this.sparkVectors) {
                        this.sparks.push(
                            new Spark(
                                ...
                                p.createVector(velVec.x, velVec.y),
                                this.color
                            )
                        );
                    }
